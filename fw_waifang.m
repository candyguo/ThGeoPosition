...
hang_time=[F_Line(hang_index,8),F_Line(hang_index+1,8)];
...
R1=[0.9063626648  0.0000019373  -0.4225005560
    0.0000034208  0.9999999999  0.0000118508 
    0.4225005718  -0.0000121824  0.9063626574]; 
W=W1*R1';%to satisfy the colineaity
end
